                            ...
                            @isset($article)
                                <form role="form" action="{{url(route('admin/articles/update', $article->id))}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group input-group">
                                        ...
                                        <input name="title" type="text" class="form-control" placeholder="Title" value="{{ $article->title }}">
                                        @error('title')
                                    ...
                                    <div class="form-group input-group">
                                        <span class="input-group-addon" style="color: red;">*</span>
                                        <!-- <input name="description" type="text" class="form-control" placeholder="Description" value="{{ $article->description }}"> -->
                                        <textarea class="form-control" name="description" placeholder="Description" rows="2">{{ $article->description }}</textarea>
                                        @error('description')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
