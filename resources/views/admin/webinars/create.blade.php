                ...
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#webinar_ar" data-toggle="tab">Webinar AR</a></li>
                            <li><a href="#webinar_en" data-toggle="tab">Webinar EN</a></li>
                        </ul>
                    </div>
                </div>
                <div class="panel-body">
                    <form role="form" action="{{url(route('admin/webinars/create'))}}" method="post" enctype="multipart/form-data">
                        <div class="tab-content">
                            @csrf
                            <div class="tab-pane fade in active" id="webinar_ar">
                            ...
                            <div class="tab-pane fade" id="webinar_en">
                                <div class="form-group input-group">
                                    <span class="input-group-addon" style="color: red;">*</span>
