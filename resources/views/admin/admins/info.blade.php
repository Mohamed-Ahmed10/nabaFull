                                ...
                                <div class="panel-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="basic_info">
                                            <form role="form" action="{{url(route('admins/info-update'))}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                        ...
                                        <div class="tab-pane fade" id="change_pass">
                                            <form role="form" action="{{url(route('admins/change-password'))}}" method="post">
                                                @csrf
                                                <div class="form-group input-group">
                                                    <span class="input-group-addon" style="color: red;">*</span>
