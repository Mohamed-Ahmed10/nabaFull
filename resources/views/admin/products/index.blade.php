                                                ...
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li>
                                                                <a href="{{route('admin/products/section/index', $product->id)}}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-info">
                                                                    options
                                                                </a>
                                                            </li>
                                                            <li class="divider"></li>
                                                            <li>
                                                                <a href="{{route('admin/products/edit', $product->id)}}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-success">
                                                                    edit
                                                                </a>
                                                            </li>
                                                            <li class="divider"></li>
                                            ...
                                            <td>
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li>
                                                                <a href="${options_route}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-info">
                                                                    options
                                                                </a>
                                                            </li>
                                                            <li class="divider"></li>
