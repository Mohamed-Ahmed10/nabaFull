        ...
        <div class="col-lg-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @isset($id)
                        <li class="breadcrumb-item"><a href="{{route('admin/products/section/index', $id)}}">Options</a></li>
                    @endisset
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                            <div id="dataTables-example_filter" class="dataTables_filter mb-3">
                                <a href="{{route('admin/products/section/create', $id)}}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-success">
                                    create
                                </a>
                                                ...
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li>
                                                                <a href="{{route('admin/products/section/edit', $product_section_one->id)}}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-success">
                                                                    edit
                                                                </a>
                                                            </li>
                                                            <li class="divider"></li>
                                            ...
                                            <td class="center">
                                                <ul class="nav navbar-center navbar-top-links" style="border-radius: 15px;">
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-user">
                                                            <li>
                                                            <a href="{{route('admin/products/section/edit', $product_section_tow->id)}}" style="text-decoration: none; color: white; width: 75px;margin:auto" class="btn btn-success">
                                                                    edit
                                                                </a>
                                                            </li>
                                                            <li class="divider"></li>
